...
en:
  ...
  specs: |-
    ...
    Total Living Space: 3,806 sq ft
    Bedrooms: 6
    Bathrooms: 5
    Garage: 2 car garage
    Year Built: 2022
fr:
  ...
  description: Cette maison contemporaine présente une architecture moderne qui
    combine confort et fonctionnalité. La propriété offre un aménagement à aire
    ouverte lumineux avec beaucoup de lumière naturelle dans les espaces de vie.
    La cuisine comprend un grand îlot central, beaucoup d’armoires, deux éviers
    et des comptoirs en granit. La maison comprend également de grands espaces
    de vie conçus pour la vie quotidienne et pour recevoir.
  specs: |-
    Type de propriété: Résidence résidentielle
    Niveaux: 2 étages + sous-sol entièrement aménagé
    Superficie habitable totale: 3,806 pi²
    Chambres: 6
    Salles de bain: 5
